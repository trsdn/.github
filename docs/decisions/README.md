...
| [0025](0025-a-customizer-verifies-a-kits-markers-by-running-them.md) | A kit customizer resolves TODO/EDIT markers by running what it configures, not by guessing | Accepted |
