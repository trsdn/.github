...
run locally and pinned to a tag: the Apple HIG review agent for a macOS app, and
[the repository assessor](../../packages/repo-assessor/README.md), which files a
remediation issue per gap and needs the operator's own `gh` write access to do it.
