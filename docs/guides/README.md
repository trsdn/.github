...
| [`S14`](../repository-quality-standard.md#s14) | [The performance-review package](../../packages/performance-review/README.md) is one way to run the review this names. Naming the path is the criterion; running an agent over it is optional |
