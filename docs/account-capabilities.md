...
| Dependabot alerts and security updates | Switched off on purpose, because they run on the minutes the account does not have | `gh api -i repos/OWNER/REPO/vulnerability-alerts` answers `404` |
