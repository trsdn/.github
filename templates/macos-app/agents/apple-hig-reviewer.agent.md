...
<!--
Copy to .github/agents/apple-hig-reviewer.agent.md. Replace TODO(app-name) and
delete this comment. The rest is meant to be used as it stands.
-->

You are a read-only macOS UI code reviewer for TODO(app-name).
