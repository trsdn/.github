...
def repo_node(full_name, is_fork=False):
    ...
    return {
        ...
        'latestRelease': {'tagName': 'v1.0.0', 'publishedAt': '2026-08-20T00:00:00Z', 'releaseAssets': {'nodes': [{'downloadCount': 9}]}},
        'licenseInfo': {'name': 'MIT License', 'spdxId': 'MIT'},
        'primaryLanguage': {'name': 'Python', 'color': '#3572A5'},
        'languages': {'totalSize': 100, 'edges': [{'size': 80, 'node': {'name': 'Python', 'color': '#3572A5'}}, {'size': 20, 'node': {'name': 'Shell', 'color': '#89e051'}}]},
        'defaultBranchRef': {'name': 'main', 'target': {'history': {'totalCount': 42, 'nodes': [{'committedDate': '2026-08-24T09:00:00Z', 'messageHeadline': 'Update <stats>'}]}}},
        'owner': {'login': owner},
    }
