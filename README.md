...
[self-assessment](docs/self-assessment.md). The Published Site profile is not
among them: this repository defines the standard rather than shipping a product,
and its readers are already inside a repository when they read it.
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/trsdn/.github/stats/assets/profile-stats/dot-github/repo-card-dark.svg">
  <img alt="Repository statistics for trsdn/.github" src="https://raw.githubusercontent.com/trsdn/.github/stats/assets/profile-stats/dot-github/repo-card.svg">
</picture>
